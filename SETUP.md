...
bot real conectado a Telegram, Groq y una base de datos.
...
| `GROQ_API_KEY` | La clave para usar Groq (categoriza y resume) | Crea una cuenta en [console.groq.com](https://console.groq.com) (tiene plan gratuito) → **API Keys → Create API Key** |
...
Verás en la consola si cada pieza (Telegram, Groq, base de datos) está
...
- **[README.md](./README.md)** — explica qué hace el proyecto y cómo está
  organizado.
- **[dashboard/README.md](./dashboard/README.md)** — dashboard web opcional
  (Next.js) para consultar tus mensajes desde el navegador; se despliega
  aparte del bot.
