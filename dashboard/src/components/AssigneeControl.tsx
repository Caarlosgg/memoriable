    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className="flex items-center gap-1 rounded-full border border-dashed border-paper-line px-1.5 py-0.5 text-xs text-muted transition-colors hover:border-accent hover:text-accent-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          {assignee ? <Avatar email={assignee.email} size="xs" /> : <UserPlus aria-hidden size={11} />}
        </button>
      </DropdownMenuTrigger>
      <DropdownMenuContent
        align="start"
