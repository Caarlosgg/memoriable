// Copia sincronizada de ../../../../src/ai/embedder.ts — ver
...
/**
 * Embedder respaldado por la API de Gemini. Implementado con `fetch`
 * directo (sin el SDK `@google/genai`): una única petición REST sin
 * streaming no lo justifica, y así el archivo es copiable tal cual entre
 * el bot y el dashboard.
 */
